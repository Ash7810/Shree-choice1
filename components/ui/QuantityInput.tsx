...
export const QuantityInput: React.FC<QuantityInputProps> = ({ initialQuantity, onQuantityChange, maxQuantity }) => {
    ...
    return (
        <div className="flex items-center border-2 border-gray-200 rounded-lg w-fit bg-white h-11">
            <button className="px-3 text-gray-500 h-full hover:bg-gray-100" onClick={() => adjustQuantity(-1)} aria-label="Decrease quantity">
            ...
            <input
                ...
                aria-label="Quantity"
            />
            <button className="px-3 text-gray-500 h-full hover:bg-gray-100" onClick={() => adjustQuantity(1)} aria-label="Increase quantity">
