        ...
        <div>
            <div className="mb-6 relative w-full max-w-sm">
                ...
                <input
                    ...
                    className="w-full p-3 pl-12 border border-slate-200 rounded-lg bg-white"
                />
            </div>
             {/* Mobile View: Cards */}
                ...
                {filteredProducts.map(product => (
                    <div key={product.id} className="bg-white rounded-xl shadow-sm border p-4 flex items-center justify-between">
                        <div className="flex items-center gap-4 flex-1 min-w-0">
                             <img src={product.image_url} alt={product.name} className="w-12 h-12 rounded-lg object-cover border flex-shrink-0" />
